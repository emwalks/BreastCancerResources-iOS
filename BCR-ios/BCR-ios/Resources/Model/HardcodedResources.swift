...
struct HardcodedResources {
    ...
    init() {
        self.myHardcodedResourceAttributes = Resource(title: "The Complete Guide to Breast Cancer",
        ...
        self.mySecondHardcodedResourceAttributes = Resource(title: "You, Me and the Big C",
